...
RFP.fit.nonzero.intercept = lm(GFP.rate~growth.rate, RFP.data)
...
BFP.fit.fixed.zero = lm(GFP.rate~growth.rate + 0, BFP.data)
BFP.slope.fixed.zero = coef(RFP.fit.fixed.zero)

BFP.fit.nonzero.intercept = lm(GFP.rate~growth.rate, BFP.data)
